		...
		<div class="wrapper">
			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					...
					<form class="forgot_password active" action="${pageContext.request.contextPath}/forgot" method="post">
						...
						<div class="bottom">
							...
							<a href="${pageContext.request.contextPath}/login" rel="login">Suddenly remebered? Log in here</a>
