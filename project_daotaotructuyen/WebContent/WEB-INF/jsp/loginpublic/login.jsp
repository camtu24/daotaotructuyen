...
<html>
    <head>
		...
		<script src="${defines.urlPublic }/loginpublicjs/cufon-yui.js" type="text/javascript"></script>
		<script src="${defines.urlPublic }/loginpublicjs/ChunkFive_400.font.js" type="text/javascript"></script>
