  ...
  <div class="container-fluid">
    ...
    <div id="Khoahoc" class="tabcontent1 row-fluid">
      <div class="span12">
        ...
        <hr>
        <h2 style="color: #555555; font-size: 28px; font-weight: normal;">Quản lý bài giảng</h2>
        <div class="">
			<a href="${pageContext.request.contextPath }/admin/course/${kid }/lesson/add" class="button">
			 <span style = "width: 155px;" class=addtop>Thêm bài giảng <i class="icon-plus"></i></span> </a>
		</div>
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Data table</h5>
              ...
              <tbody>
              	<c:forEach items="${listBG }" var="objBG">
	                <tr class="gradeX">
	                  ...
	                  <td>${objBG.nguoiTao}</td>
	                  <td width="22%" style="text-align: center;">
	                      <!-- <a href="" class="btn btn-success"><i class="icon-eye-open"></i> View</a> -->
	                      <a href="${pageContext.request.contextPath }/admin/course/${kid }/lesson/edit/${objBG.id_BaiHoc}" class="btn btn-info"><i class="icon-edit"></i> Edit</a>
	                      <a href="${pageContext.request.contextPath }/admin/course/${kid }/lesson/del/${objBG.id_BaiHoc}" onclick="return confirm('Are you sure you want to delete this item?')" class="btn btn-danger"><i class="icon-remove-sign"></i> Delete</a>
	                  </td>
