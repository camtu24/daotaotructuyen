...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb">
			...
			<a href="${pageContext.request.contextPath }/admin/course/${id }/cats" class="tip-bottom">Danh mục bài giảng</a> <a href="#" class="current">Thêm danh mục bài giảng</a>
		</div>
		<h1>Danh mục bài giảng</h1>
	</div>
	<div class="container-fluid"><hr>
		<div class="header">
			<h4 class="title">Thêm danh mục bài giảng</h4>
		</div>
		<div class="widget-box">
			<div class="widget-title"> <span class="icon"> <i class="icon-circle-arrow-left"></i> </span>
	            <h5> <a href="${pageContext.request.contextPath }/admin/course/${id }/cats">Quay lại </a></h5>
	        </div>
