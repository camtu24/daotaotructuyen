...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-group"></i> <span>Quản lý tài khoản</span> <i class="icon-caret-down" style="margin-left: 25px;"></i></a>
      <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Quản lý khóa học</span> <i class="icon-caret-down" style="margin-left: 25px;"></i></a>
      <ul>
     ...
     <li><a href="${pageContext.request.contextPath }/admin/management/students"><i class="icon icon-globe"></i> <span>Quản lý học viên</span></a></li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Thông tin lưu trữ</span> <i class="icon-caret-down" style="margin-left: 25px;"></i></a>
      <ul>
