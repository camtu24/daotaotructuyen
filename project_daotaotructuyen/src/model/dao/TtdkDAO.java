...
public class TtdkDAO {
	...
	public int addItem(ThongTinDangKy TTDK,int kid, int id_ThanhToan) {
	...
	public List<ThongTinDangKy> getItems(int storage) {
		...
		return jdbcTemplate.query(sql,new Object[] {storage}, new BeanPropertyRowMapper<ThongTinDangKy>(ThongTinDangKy.class));
	}
